...
{
    public class UltimaShield : ModNPC
    {
        public float rot;
        ...
        public override bool PreAI()
        {
            ...
            if (boss < 0 || boss >= 200 || !Main.npc[boss].active || Main.npc[boss].type != mod.NPCType("UltimaNova"))
            {
                npc.active = false;
                return false;
            }
            ...
            npc.Center = npc2.Center + ColorSwordsHelper.RotateVector(new Vector2(), this.rotVec, this.rot + npc.ai[2] * 0.628f);
            return false;
        }
