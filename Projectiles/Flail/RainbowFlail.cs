...
namespace ColorSwords.Projectiles.Flail
{
	public class RainbowFlailProjectile : ModProjectile
	{
		
		private const string ChainTexturePath = "ColorSwords/Projectiles/Flail/RainbowFlailProjectileChain";

		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Rainbow Flail Ball"); 
		}
