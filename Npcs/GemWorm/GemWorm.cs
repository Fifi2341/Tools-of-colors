...
{
	[AutoloadBossHead]
	internal class GemWormHead : GemWorm
	{
		public override string Texture { get { return "ColorSwords/Npcs/GemWorm/GemWormHead"; } }
		public override void SetDefaults()
		{
			...
			music = MusicID.Boss2;
			npc.boss = true;
			bossBag = ModContent.ItemType<GemWormBag>();
		}
		...
		public override void CustomBehavior() {
			if (Main.netMode != NetmodeID.MultiplayerClient) {
				...
				if (attackCounter <= 0 && Vector2.Distance(npc.Center, target.Center) < 200 && Collision.CanHit(npc.Center, 1, 1, target.Center, 1, 1)) {
					...
					int projectile = Projectile.NewProjectile(npc.Center, direction * 1, ProjectileID.CultistBossLightningOrb, 5, 0, Main.myPlayer);
	...
	public abstract class GemWorm : Worm
	{
		public override void SetStaticDefaults()
		{
			DisplayName.SetDefault("Gem Worm");
		}
		public override void Init()
		{
			minLength = 160;
			maxLength = 161;
			tailType = NPCType<GemWormTail>();
			bodyType = NPCType<GemWormBody>();
			headType = NPCType<GemWormHead>();
			speed = 15.5f;
			turnSpeed = 1.045f;
		}
	}
	public abstract class Worm : ModNPC
	{
		...
		public override void NPCLoot()
		{
			...
			else
			{
				...
				{
					Item.NewItem(npc.getRect(), ModContent.ItemType<ZombifiedBar>());
					Item.NewItem(npc.getRect(), ModContent.ItemType<EasterBox>());
				}
			}
		}
    }
